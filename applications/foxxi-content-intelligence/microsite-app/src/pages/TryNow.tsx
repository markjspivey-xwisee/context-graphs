      ...
      <section style={{ maxWidth: 880, margin: '40px auto 24px', padding: '0 24px' }}>
        ...
        <div style={{
          ...
          <div style={{ marginTop: 14, fontSize: 14, color: 'var(--text)', lineHeight: 1.6 }}>
            ...
            {role === 'le' && <>You're seeing what Ngozi sees. A learning engineer sits in the L&amp;D org's <strong>technical / R&amp;D track</strong> — fluent in IEEE P2247 (Adaptive Instructional Systems) and the ADL Total Learning Architecture stack (xAPI / cmi5 / SCORM 2004) the substrate ingests, plus the 1EdTech competency standards (CASE / CaSS / CLR / Open Badges 3.0) the substrate emits. They get <strong>cohort-wide read access</strong> for analytics (no credential issuance) — design A/B experiments, calibrate mastery thresholds with BKT / IRT, run framework-gap analyses against IEEE LERS-aligned content, and detect plateaus in cohort learning curves. Instructional design × data science × edtech standards engineering.</>}
          </div>
        </div>
      </section>
