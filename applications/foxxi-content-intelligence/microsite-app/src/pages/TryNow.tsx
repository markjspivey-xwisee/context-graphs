      ...
      <section style={{ maxWidth: 880, margin: '40px auto 24px', padding: '0 24px' }}>
        ...
        <div style={{
          ...
          <div style={{ marginTop: 14, fontSize: 14, color: 'var(--text)', lineHeight: 1.6 }}>
            ...
            {role === 'le' && <>You're seeing what Ngozi sees. Learning engineers get <strong>cohort-wide read access</strong> for analytics (no credential issuance) — they design experiments, calibrate mastery thresholds, find gaps between competency frameworks and what's actually taught, and detect plateaus in learning curves. The cross of instructional design + data science applied to your tenant's learning system.</>}
          </div>
        </div>
      </section>
